<template>
  <section>
    ...
    <section class="action-box top-pad">
      ...
      <p>Sorry, this is temporarily unavailable as we reformat all of the translations.</p>
...
export default {
  ...
  computed: {
    ...mapState(["scatter", "ports"]),
    ...mapGetters(["showNotifications", "version", "networks", "language"]),
    dataPath() {
  ...
  methods: {
    ...
    ...mapActions([Actions.SET_SCATTER, Actions.SET_LANGUAGE])
  }
};
</script>
